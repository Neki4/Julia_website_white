    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <img
          src="/hero-bg.jpg"
          alt=""
          className="w-full h-full object-cover object-top opacity-[0.64]"
        />
      ...
      >
        <div>
          <p>
            Довірити мені вашу зйомку — це отримати значно більше, ніж просто
            фото:
          </p>
          <ul className="mt-3 flex flex-col gap-1.5 list-disc pl-5">
            <li>легкість у спілкуванні</li>
            <li>підготовка до зйомки з найменшими деталями</li>
            <li>неймовірна атмосфера довіри під час зйомки</li>
            <li>анонс зйомки за декілька днів, для отримання перших емоцій</li>
            <li>
              отримання всіх фото у гарній галереї і впевненість у виборі мене
              як фотографа
            </li>
          </ul>
        </div>
        <p>
          <strong className="font-medium">
            Я зловлю найважливіші та найемоційніші моменти вашого свята.
          </strong>{' '}
          Мені щоразу неймовірно радісно бачити ваші сяючі усмішки під час
          зйомки. Я бережно допоможу, але підкреслю на фото саме Вас! Це
          важливо як на індивідуальній зйомці, так і під час взаємодії.
        </p>
        <p>
          ...
          фінальний результат.{' '}
          <strong className="font-medium">
            Буду рада стати частиною вашого свята.
          </strong>
        </p>
      </div>
