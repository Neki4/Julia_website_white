...
function Hero() {
  ...
  return (
    <section ref={ref} className="mx-auto max-w-[440px] px-6 pt-12 md:pt-16">
      ...
      >
        <p>
          Понад 8 років я знімаю людей — весілля, хрещення, сімейні та парні
          історії. За цей час — 400+ зйомок і сотні родин, які повертаються до
          мене щороку.
        </p>
        <p>
        ...
        <p>Зйомки — від 4 000 грн за годину.</p>
      </div>
